...
def search_files(spectrum_file, library_file, temp_folder, tempresults_folder, path_to_convert, path_to_main_exec,
    ...
    parameter_filename = os.path.join(temp_folder, "parametersINI" + ".params")
...
def main():
    ...
    parser.add_argument('--convert_binary', default='./convert', help='conversion binary')
    parser.add_argument('--librarysearch_binary', default='./main_execmodule',help='librarysearch_binary') # = main_execmodule
